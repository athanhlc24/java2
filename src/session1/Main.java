...
public class Main {
    public static void main (String[]args){
        ...
        st.add(new Student("Nguyễn Thị Hằng ",4));
        st.add(new Student("Nguyễn Thị Hường ",2));
        st.add(new Student("Nguyễn Thị Huyền ",3));
        Student s;
        while ( st.size()>0){
            s = st.poll();
        ...
        System.out.println("Tiêu chuân làm sinh viên xuất săc phải đạt: "+hm.get("good Student"));
